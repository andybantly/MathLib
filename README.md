...
It can be constructed or assigned with a string representation of a signed integer, a signed integer, or a byte value and capacity.
...
It doesn’t yet cast/return quantities that the language understands.  Eg:  Some kind of integer operator (casting operator) that returns an integer representation
