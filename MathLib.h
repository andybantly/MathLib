...
extern "C" static int contract(std::string strInput, std::string & strResult);
extern "C" static int expand(std::string sInput, std::string & strResult);
...
// Negative powers add 'th' to the word
...
std::vector<std::string> g_vstrHuns;
